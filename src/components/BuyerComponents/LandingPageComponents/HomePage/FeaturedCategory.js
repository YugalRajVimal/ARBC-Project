  ...
  return (
    <div className="h-[34%] flex flex-col justify-center items-center">
      ...
      <div
        ...
        className="w-[95%] h-[40%] bg-[#ebedfd] shadow-[0px_0px_10px_2px_rgba(0,0,0,0.2)] rounded-md p-2 flex-col md:flex-row flex justify-around items-center"
      >
        <h3 className="flex flex-col font-bold">{featuredCategory.text}</h3>
        <div className="w-full md:w-[50%] h-[90%] flex pb-2">
          <div
            onClick={(e) => (
              e.stopPropagation(),
            ...
            className="h-full w-full bg-white rounded-sm flex justify-around items-center p-2"
          >
